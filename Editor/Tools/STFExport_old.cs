...
namespace stf
{
	public class STFUIExport_old : EditorWindow
	{
		private Vector2 scrollPos;
		private GameObject go;

		[MenuItem("STF Tools/Export old")]
		public static void Init()
		{
			STFUIExport_old window = EditorWindow.GetWindow(typeof(STFUIExport_old)) as STFUIExport_old;
